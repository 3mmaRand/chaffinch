...
There is another figure showing the distribution of the data in @fig-chaff-dist presented here only to demonstrate the auto numbering of figures. The same figure is in "Supplemental Figures". See @suppfig-chaff-dist2
...
Here's that same figure again, but this time it's in the supplemental material.
